          ...
          items: [
            {
              ...
              items: [
                ...
                { text: 'Light Flicker', link: '/mechanics/states/LightFlickerState' },
                { text: 'Throwing', link: '/mechanics/states/ThrowingState' },
                { text: 'Ignite', link: '/mechanics/states/IgniteState' },
                { text: 'DOTS', link: '/mechanics/states/DOTSState' },
                { text: 'TeleportObject', link: '/mechanics/states/TeleportObjectState' },
              ],
            },
